...
public class OrthoCachedTiledMapRenderer implements TiledMapRenderer, Disposable {
    ...
    protected int extraRenderTileDistance = 0;
    ...
    public void renderTileLayer (TiledMapTileLayer layer) {
        ...
        final int col1 = Math.max(0, (int)((cacheBounds.x / layerTileWidth) - extraRenderTileDistance));
        final int col2 = Math.min(layerWidth, extraRenderTileDistance + (int)((cacheBounds.x + cacheBounds.width + layerTileWidth) / layerTileWidth));

        final int row1 = Math.max(0, -extraRenderTileDistance + (int)(cacheBounds.y / layerTileHeight));
        final int row2 = Math.min(layerHeight, extraRenderTileDistance + (int)((cacheBounds.y + cacheBounds.height + layerTileHeight) / layerTileHeight));
    ...
    public int getExtraRenderTileDistance() {
        return extraRenderTileDistance;
    }

    /**
     * Sets the amount of extra distance in tiles that the renderer will render. This is helpful when your tiles don't
     * match the actual size of the tile
     * @param extraRenderTileDistance
     */
    public void setExtraRenderTileDistance(int extraRenderTileDistance) {
        this.extraRenderTileDistance = extraRenderTileDistance;
    }
}
